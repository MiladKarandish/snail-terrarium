...
ps = [["mm_module_od",mm_module_od],["mm_module_h",mm_module_h],
 ...
 ["bottle_ml",bottle_ml],["fan_z",fan_z],["nozzle_z",nozzle_z],["nozzle_d",nozzle_d],["feed_centre",feed_centre],["feed_od",feed_od],["feed_id",feed_id],["feed_port_d",feed_port_d],["ch_flange_h",ch_flange_h],["vessel_od",vessel_od],["vessel_cut_h",vessel_cut_h],["skirt_slop",skirt_slop]];
